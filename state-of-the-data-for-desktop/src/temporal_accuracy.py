...
def main(*argv):
    ...
    try:
        currency_features = argv[0]
        change_detection_features = argv[1]
        temporal_accuracy_output = argv[2]

        RunTemporalAccuracy = TemporalAccuracy(change_detection_features,
                                               currency_features, temporal_accuracy_output)
        RunTemporalAccuracy.create_temporal_accuracy()
